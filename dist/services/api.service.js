            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (auth && auth.startsWith("Bearer")) {
                    ...
                    if (token == "123456") {
                        ...
                        // Invalid token
                        throw new moleculer_web_1.default.Errors.UnAuthorizedError(moleculer_web_1.default.Errors.ERR_INVALID_TOKEN, null);
                    }
                }
                else {
        ...
        authorize(ctx, route, req) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (req.$action.auth == "required" && !user) {
                    throw new moleculer_web_1.default.Errors.UnAuthorizedError("NO_RIGHTS", null);
                }
            });
        }
    }
